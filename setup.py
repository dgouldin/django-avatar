...
AVATAR_LOADERS
    An iterable of import paths to avatar loader functions. Loader functions
    take two arguments (the current user and the desired avatar size) and
    return the url of an avatar or None if the loader fails. The first
    loader to succeed will be used as the avatar url.

AVATAR_DEFAULT_URL
    The avatar URL used by the default avatar loader.
